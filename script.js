let cityInput = document.getElementById("city_input"),
  ...
  locationBtn = document.getElementById("locationhBtn"),
  api_key = "500268431d77c2624dcd63b2a4e9998c",
  ...
  fetch(WEATHER_API_URL)
    ...
    .then((data) => {
      ...
      currentWeatherCard.innerHTML = `
        ...
        feelsVal.innerHTML = `${(feels_like - 273.15).toFixed(2)}&deg}`;
...
function getCityCoordinates() {
  ...
  cityInput.value = "";
  if (!cityName) return;
  let GEOCODING_API_URL = `http://api.openweathermap.org/geo/1.0/direct?q=
